const myWork = 
    `<section class="work animated" id="work">
            ...
            <section class="project">
				...
				<p class='name'>Node.js</p> <p class='name'>React.js</p > <p class='name'>Redux</p>
                <div class="project-links">
                    <ul class="links-to-demos">
                        <li class="project-link project-link-live">
                            <a href="https://sheltered-lowlands-31144.herokuapp.com">Live demo</a>
                        </li>
                        <li class="project-link project-link-github">
                            <a href="https://github.com/PROB8/learningo">Source code</a>
                        </li>
                    </ul>
				</div>
            ...
            <p class="project-description">
                Simple app that provides horoscopes/motivational quotes.
            </p>
            <ul class="project-stack">
                <li class="project-stack-item"> 
                   <img class="node-logo" src="./pix/nodelogo.png">
            ...
            <div class="project-links">
                <ul>
                    <li class="project-link project-link-live">
                        <a href="https://findmyhoroscope.herokuapp.com">Live demo</a>
                    </li>
                    <li class="project-link project-link-github">
                        <a href="https://github.com/PROB8/find-my-horoscope">Source code</a>
                    </li>
                </ul>
			</div>
			<div class='border-bottom'><div>
            ...
            <section class="project">
                ...
                <p class="project-description">
                    An app that allows you to collect the world's opinion.
                </p>
                <ul class="project-stack">
                    <li class="project-stack-item"> 
                       <img class="node-logo" src="./pix/nodelogo.png">
                ...
                <div class="project-links">
                    <ul>
                        <li class="project-link project-link-live">
                            <a href="http://vast-hamlet-89391.herokuapp.com/">Live demo</a>
                        </li>
                        <li class="project-link project-link-github">
                            <a href="https://github.com/PROB8/naeem-polling">Source code</a>
                        </li>
                    </ul>
				</div>
				<div class='border-bottom'><div>
            ...
            <section class="project">
                ...
                <div class="project-links">
                    <ul>
                        <li class="project-link project-link-live">
                            <a href="https://www.npmjs.com/package/arithmetik">npm Page</a>
                        </li>
                        <li class="project-link project-link-github">
                            <a href="https://github.com/PROB8/npm-gitonga">Source code</a>
                        </li>
					</ul>
...
//THE CODE BELOW IS EVENT DELEGATION, NECESSARY SOMETIME DYNAMICALLY CHANGING 
